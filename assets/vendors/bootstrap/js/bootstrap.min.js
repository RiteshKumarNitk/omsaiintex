...
if ("undefined" == typeof jQuery) throw new Error("Bootstrap's JavaScript requires jQuery"); + function(t) {
    ...
    s.VERSION = "3.4.1", s.TRANSITION_DURATION = 150, s.prototype.close = function(e) {
        ...
        o || (o = n.attr("href"), o = o && o.replace(/.*(?=#[^\s]*$)/, "")), o = "#" === o ? [] : o;
    ...
    i.VERSION = "3.4.1", i.TRANSITION_DURATION = 600, i.DEFAULTS = {
        ...
        if (this.$element.trigger(h), !h.isDefaultPrevented()) {
            ...
            return t.support.transition && this.$element.hasClass("slide") ? (o.addClass(e), "object" == typeof o && o.length && o[0].offsetWidth, n.addClass(r), o.addClass(r), n.one("bsTransitionEnd", function() {
    ...
    a.VERSION = "3.4.1", a.prototype.toggle = function(s) {
        var n = t(this);
    ...
    i.VERSION = "3.4.1", i.TRANSITION_DURATION = 300, i.BACKDROP_TRANSITION_DURATION = 150, i.DEFAULTS = {
        ...
        this.bodyIsOverflowing && (this.$body.css("padding-right", e + i), t(this.fixedContent).each(function(e, s) {
            ...
            t(s).data("padding-right", n).css("padding-right", parseFloat(o) + i + "px")
        }))
        ...
        this.$body.css("padding-right", this.originalBodyPad), t(this.fixedContent).each(function(e, i) {
            ...
            t(i).removeData("padding-right"), i.style.paddingRight = s ? s : ""
        })
    ...
    t.fn.modal = e, t.fn.modal.Constructor = i, t.fn.modal.noConflict = function() {
        ...
        var s = t(this),
            n = s.attr("href"),
            o = s.attr("data-target") || n && n.replace(/.*(?=#[^\s]+$)/, ""),
            a = t(document).find(o),
    ...
    s.VERSION = "3.4.1", s.TRANSITION_DURATION = 350, s.DEFAULTS = {
        ...
        return t(document).find(this.options.parent).find('[data-toggle="collapse"][data-parent="' + this.options.parent + '"]').each(t.proxy(function(i, s) {
            var n = t(s);
