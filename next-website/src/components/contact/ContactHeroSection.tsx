...
export default function ContactHeroSection() {
  ...
  return (
    <section ref={sectionRef} className="relative w-full min-h-[60vh] flex items-center justify-center bg-black overflow-hidden pt-28">
      <div className="absolute inset-0 bg-gradient-to-b from-blue-500/5 via-transparent to-black/50" />
      ...
      <div className="container mx-auto px-6 md:px-12 text-center relative z-10">
        <p ref={subRef} className="text-blue-400 uppercase tracking-[0.3em] text-sm font-semibold mb-6 opacity-0">
          Get In Touch
        </p>
        <h1
          ref={headingRef}
          className="text-5xl md:text-7xl lg:text-[72px] font-bold text-white leading-tight"
